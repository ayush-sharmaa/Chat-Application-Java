...
public class Server implements ActionListener{
    ...
    Server(){
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icons/naga2.png"));
        Image i5 = i4.getImage().getScaledInstance(35,35, Image.SCALE_DEFAULT);
        ImageIcon i6 = new ImageIcon(i5);
        JLabel profile = new JLabel(i6);
        profile.setBounds(40,7,35,35);
        p1.add(profile);
        ...
        more.setBounds(420,10,10,25);
        p1.add(more);

        JLabel name = new JLabel("Naga");
        ...
        status.setBounds(90,28,90,12);
        status.setForeground(Color.WHITE);
        status.setFont(new Font(Font.SANS_SERIF, Font.PLAIN, 12));
        p1.add(status);

        a1 = new JPanel();
        a1.setBounds(2,48,445,604);
        f.add(a1);

        text = new JTextField();
        text.setBounds(2,655,325,42);
        text.setFont(new Font(Font.SANS_SERIF,Font.PLAIN, 14));
        f.add(text);

        JButton send = new JButton("Send");
        send.setBounds(322,655,125,40);
        send.setBackground(new Color(7,94,84));
        send.setForeground(Color.WHITE);
        send.addActionListener(this);
        send.setFont(new Font(Font.SANS_SERIF,Font.PLAIN, 14));
        f.add(send);
    ...
    public static JPanel formatLabel(String out){
        ...
        output.setBackground(new Color(211,211,211));
